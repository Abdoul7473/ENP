        ...
        <div style="margin-top: 5px;">
            <table style="border-collapse: collapse; width: 105%;" >
                ...
                <tr style="background-color:darkgreen; color:white">
                    ...
                    <td style="text-align:center;font-size: 13px;"><b>Date facture</b></td>
                    <td style="text-align:center;font-size: 13px;"><b>N° facture</b></td>
                    <td style="text-align:center;font-size: 13px;"><b>Ref facture</b></td>
                    <td style="text-align:center;font-size: 13px;"><b>N° client</b></td>
                    <td style="text-align:center;font-size: 13px;"><b>Ref article</b></td>
                ...
                @if(isset($orderData[0]) && $orderData[0] instanceof \App\Models\Order)
                    ...
                    <td style="text-align:center;">{{$orderData['num_facture']}}</td>
                    <td style="text-align:center;">{{$orderData['num_facture_format']}}</td>
                    <td style="text-align:center;">{{$order->postulant->code}}</td>
                    <td style="text-align:center;">{{$orderData['ref_article']}}</td>
                    ...
                    <td style="text-align:center;">{{number_format($orderData['montant'], 0, '', ' ')}}</td>
